            ...
            schemas: {
                ...
                Opera: {
                    ...
                    properties: {
                        ...
                        titolo: { type: "string", example: "Il visconte dimezzato" },
                        anno_pubblicazione: { type: "integer", example: 1952 },
                        tipo_opera: { type: "integer", example: 1 },
                        stato_opera: { type: "string", enum: ["finito", "in corso"] },
                ...
                OperaInput: {
                    type: "object",
                    required: ["titolo", "anno_pubblicazione", "tipo_opera"],
                    properties: {
                        titolo: { type: "string", minLength: 2 },
                        anno_pubblicazione: { type: "integer", minimum: 0 },
